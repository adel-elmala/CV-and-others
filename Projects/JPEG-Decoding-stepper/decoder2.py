...
class jpeg():
    ...
    def prettyDisplay(self):
        ...
        for i in range(8):
            print(self.quantTables[0].data[0][i*8:(i+1)*8])
        print("====== Quantization Table 1 ====== ")
        for i in range(8):
            if (len(self.quantTables[0].data) == 2):
                print(self.quantTables[0].data[1][i*8:(i+1)*8])
            else:
                print(self.quantTables[1].data[0][i*8:(i+1)*8])
...
# # print(markers)
# file1  = open("peter-progressive.jpeg", "rb").read(markers[1]-2)
# file2  = open("peter-progressive.jpeg", "rb").read(markers[2]-2)
# file3  = open("peter-progressive.jpeg", "rb").read(markers[3]-2)
# file4  = open("peter-progressive.jpeg", "rb").read(markers[4]-2)
# file5  = open("peter-progressive.jpeg", "rb").read(markers[5]-2)
# file6  = open("peter-progressive.jpeg", "rb").read(markers[6]-2)
# file1  = open("peter-progressive.jpeg", "rb").read(markers[1]-1)


# print(markers[1])
# print(type(file))
# print(file.jpgDataList[793])
...
#     jpegFile = open('{}.jpeg'.format(i),"wb")
#     jpegFile.write(files[i])
#     jpegFile.write(b'\xff\xd9')
#     jpegFile.close()
    # jpegFile = open('{}.jpeg'.format(i),"rb")
    # # s =io.BytesIO(files[i])
    # img = Image.open(jpegFile)
    # img.save('output-{}.jpeg'.format(i))

# print(open('out.jpeg','rb').read())
